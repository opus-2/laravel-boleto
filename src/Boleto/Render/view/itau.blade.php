...
<table class="table-boleto espaco-vertical" cellpadding="0" cellspacing="0">
	<tbody>
		<tr>
			<td valign="bottom" colspan="8" class="noborder nopadding">
				...
				<div class="linha-digitavel" style="line-height: 1.8";>Recibo do pagador<br>{{ $linha_digitavel }}</div>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="8" class="norightborder noleftborder top-2" style="padding-left:0; padding-top:3px">
				<div class="conteudo" style="font-weight:normal; float:right ">Autenticação mecânica</div>
			</td>
		</tr>
...
@include('BoletoHtmlRender::partials/itau-ficha-compensacao')
