<table class="table-boleto" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
        ...
        <td class="noleftborder top-2" style="vertical-align:top">
			<div class="titulo" style="position:relative; top:0; right:0; font-weight:bold; font-size:larger; text-align:right">Ficha de compensação</div>
        </td>
    </tr>
	...
	<tr>
        <td colspan="7" class="norightborder noleftborder top-2" style="padding-left:0; padding-top:3px">
		{!! $codigo_barras !!}
		</td>
		<td class="top-2 noleftborder norightborder" style="vertical-align:top;">
            <div class="conteudo noborder " style="width:100%;text-align:center;font-weight:normal; float:right">Autenticação mecânica</div>
        </td>
    </tr>
